...
<html lang="pt-br">
  <head>
    ...
    <title>Acesso Design</title>
  </head>
  <body class="bg-light">
<!-- inicio nav -->

<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  <a class="navbar-brand" href="#">Acesso Design</a>
...
<!-- fim da nav -->
  ...
  <div class="jumbotron text-center">
    ...
    <h1>Bem vindo a Acesso Design</h1>
    <p>
        Um site feito em Bootstrap 4
    </p>
  </div>
  <div class="container ">
  ...
  <div class="footer bg-dark p-5 mt-2 text-center text-light">

  <span>Acesso Design 2020</span>
